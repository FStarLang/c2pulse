...
// RecordDecl 0x555d3722ec40 </home/t-visinghal/Applications/src/c2pulse/test/issue-related/issue38_test_6.c:1:1, col:8> col:8 struct foo
// TypedefDecl 0x555d3722ed98 </home/t-visinghal/Applications/src/c2pulse/test/issue-related/issue38_test_6.c:2:1, col:21> col:21 referenced foo_ptr 'struct foo *'
// `-PointerType 0x555d3722ed40 'struct foo *'
//   `-ElaboratedType 0x555d3722ece0 'struct foo' sugar
//     `-RecordType 0x555d3722ecc0 'struct foo'
//       `-Record 0x555d3722edf0 'foo'
// RecordDecl 0x555d3722edf0 prev 0x555d3722ec40 </home/t-visinghal/Applications/src/c2pulse/test/issue-related/issue38_test_6.c:3:1, line:6:1> line:3:8 struct foo definition
// |-FieldDecl 0x555d3722ee88 <line:4:9, col:13> col:13 left 'int'
// `-FieldDecl 0x555d3722ef50 <line:5:9, col:17> col:17 next 'foo_ptr':'struct foo *'
