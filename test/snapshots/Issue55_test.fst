...
while((int32_to_bool (if (int32_to_bool ((bool_to_int32 (SizeT.lt (sizet_to_int32 (! i)) (sizet_to_int32 (! l))))))
...
};(int32_to_bool ((bool_to_int32 (SizeT.eq (sizet_to_int32 (! i)) (sizet_to_int32 (! l))))));
}
