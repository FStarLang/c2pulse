...
freeable x
ensures 
(_u32_pair_struct_pred x { first = 0ul; second = 1ul })
{
...
requires 
_u32_pair_struct_pred x s
ensures 
exists* (s2:_u32_pair_struct_spec). _u32_pair_struct_pred x s2 ** pure (s2 == ({first = s.second; second = s.first}))
{
