...
invariant b. exists* vi vl. (a1 |-> va1) ** (a2 |-> va2) ** (* tedious *) (i |-> vi) ** (va1 |-> Frac p s1) ** (va2 |-> Frac p s2) **(l |-> vl) **pure (Seq.length s1 = SizeT.v vl /\Seq.length s2 = SizeT.v vl /\SizeT.v vi <= SizeT.v vl /\(b == (SizeT.v vi < SizeT.v vl && Seq.index s1 (SizeT.v vi) = Seq.index s2 (SizeT.v vi))) /\(forall (i:nat). i < SizeT.v vi ==> Seq.index s1 i == Seq.index s2 i))
{
