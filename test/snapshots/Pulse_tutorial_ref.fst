...
r |-> w
requires 
pure (fits (+) (as_int w) (as_int n))
ensures 
exists* ww. (r |-> ww) ** pure (as_int ww == as_int w + as_int n)
{
let mut r : (ref Int32.t) = r;
let mut n : Int32.t = n;
(! r) := (Int32.add (! (! r)) (! n));
...
r |-> w
ensures 
exists* ww. (r |-> ww) ** pure (as_int ww == 4 * as_int w)
{
let mut r : (ref Int32.t) = r;
(add (! r) (! (! r)));
(add (! r) (! (! r)));
...
r |-> vr
requires 
pure (fits (+) (as_int vr) 1)
ensures 
exists* w. (r |-> w) ** pure (as_int w == as_int vr + 1)
{
let mut r : (ref Int32.t) = r;
(! r) := (Int32.add (! (! r)) 1l);
}
