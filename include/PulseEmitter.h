...
//     static std::unique_ptr<PulseFn>  emitPulseSpecFor(const
...
//     std::vector<PulseAnnotation> extractPulseAnnotations(const
//     clang::FunctionDecl* FD, const clang::SourceManager& SM);

//     // Converts a Clang expression into a Pulse-compatible string
//     std::string printPulseExpr(const clang::Expr* E, clang::PrintingPolicy&
//     Policy);
