...
val pts_to_mask (#t: Type u#a) (arr: array t) (#[full_default()] f: perm) (v: erased (Seq.seq t)) (mask: nat -> prop) : slprop
...
ghost fn share_mask u#a (#t: Type u#a) (arr: array t) #f #v #mask
  requires pts_to_mask arr #f v mask
  ensures pts_to_mask arr #(f /. 2.0R) v mask
  ensures pts_to_mask arr #(f /. 2.0R) v mask

[@@allow_ambiguous]
ghost fn gather_mask u#a (#t: Type u#a) (arr: array t) #f1 #f2 #v1 #v2 #mask1 #mask2
...
val array_base (#t: Type u#a) (arr: array t) : GTot array_base_t
val array_offset (#t: Type u#a) (arr: array t) : GTot nat

let is_sub_array_of (#t: Type u#a) (sub arr: array t) (i j: nat) =
  pure (array_offset sub == array_offset arr + i
    /\  array_base sub == array_base arr
    /\  i + length sub == j)

unobservable
fn array_sub u#a (#t: Type u#a) (arr: array t) #f #mask (i: SizeT.t) (j: SizeT.t)
...
[@@allow_ambiguous]
ghost fn return_array_sub u#a (#t: Type u#a) (arr sub: array t) #f (#v #vsub: erased (Seq.seq t)) #mask (#i #j: nat)
  requires pts_to_mask arr #f v mask
...
val array_of_ref (#t: Type u#a) (r: ref t) : array t

let is_ref_to_elem (#t: Type u#a) (r: ref t) (arr: array t) (i: nat) =
  is_sub_array_of (array_of_ref r) arr i (i+1)

unobservable
fn array_at u#a (#t: Type u#a) (arr: array t) #f #mask (i: SizeT.t) (#v: erased (Seq.seq t) { SizeT.v i < Seq.length (reveal v) })
  requires pts_to_mask arr #f v mask
...
[@@allow_ambiguous]
ghost fn return_array_at u#a (#t: Type u#a) (arr: array t) (sub: ref t) #f (#v: erased (Seq.seq t)) (#vsub: erased t) #mask (#i: nat)
  requires pts_to_mask arr #f v mask
  requires sub |-> Frac f vsub
...
fn alloc_array u#a (#a:Type u#a) {| inhabited a |} (sz:SizeT.t)
  returns  r : array a
